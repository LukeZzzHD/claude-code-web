      ...
      return (
        <>
          ...
          <div
            ref={ref}
            className={cn(
              "fixed inset-y-0 z-50 flex h-full w-[--sidebar-width-mobile] flex-col bg-sidebar text-sidebar-foreground transition-transform duration-200 ease-in-out",
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <ChevronRight className="transition-transform duration-200 group-data-[state=expanded]/sidebar-wrapper:rotate-180" />
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:group-data-[collapsible=icon]:!size-4",
        className
      )}
      {...props}
    />
